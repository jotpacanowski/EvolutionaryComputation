...
std::vector<std::vector<int>> distanceMatrix(std::vector<std::vector<int>> instance)
{
    ...
    for (int i = 0; i < instance_size; i++)
    {
        ...
        {
            int dist = (int)nearbyint(std::hypot(
                instance[i][0] - instance[j][0],
...
int evaluateSolution(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs, std::vector<int> solution)
{
...
std::vector<int> randomTSP(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs)
{
...
int nearestNeighbor(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs, int node, std::vector<int> solution)
{
...
std::vector<int> nearestNeighborTSP(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs, int starting_node)
{
    std::vector<int> solution;
...
std::vector<int> nearestNeighborAnyTSP(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs, int starting_node)
{
    std::vector<int> solution;
    if (starting_node == NULL)
    {
...
void printResults(std::vector<int> sol, bool toFile = false, char *filename = "solution.txt")
{
    if (toFile)
    {
...
void nearestNeighborTSPTask(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs)
{
    std::vector<int> sol;
    int value;
...
void nearestNeighborAnyTSPTask(std::vector<std::vector<int>> distanceMatrix, std::vector<int> costs)
{
    std::vector<int> sol;
    int value;
